...
DEV_DIR2020_SUSE     := $(DEV_STYLE_DIR)/$(DIR2020_SUSE)-ns
...
SUSESTYLEDIR2020        := $(INST_STYLE_ROOT)/$(DIR2020_SUSE)
SUSESTYLEDIR2020-NS     := $(INST_STYLE_ROOT)/$(DIR2020_SUSE)-ns
...
INST_STYLEDIRS := $(STYLEDIR2005) $(STYLEDIR2005-NS) \
   ...
   $(SUSESTYLEDIR2020) $(SUSESTYLEDIR2020-NS)
...
install: | $(INST_DIRECTORIES)
	...
	tar c --mode=u+w,go+r-w,a-s -C $(DIR2020_SUSE) . | (cd  $(SUSESTYLEDIR2020); tar xp)
	tar c --mode=u+w,go+r-w,a-s -C $(DEV_DIR2020_SUSE) . | (cd  $(SUSESTYLEDIR2020-NS); tar xp)
...
generate_xslns: | $(LOCAL_STYLEDIRS)
	...
	bin/xslns-build $(DIR2020_SUSE) $(DEV_DIR2020_SUSE)
