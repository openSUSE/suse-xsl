...
<xsl:param name="suse.doc.url">https://www.hpe.com/us/en/solutions/cloud.html</xsl:param>

<!-- SUSE  -->
<xsl:param name="company.address">Hewlett Packard Enterprise Development LP
WW Corporate Headquarters - Palo Alto, CA (B20)
3000 Hanover St.
Palo Alto
California
94304-1112
United States</xsl:param>
...
<xsl:param name="titlepage.logo.width"
  ><xsl:value-of select="2 * &column; + &gutter;"/>mm</xsl:param>
<xsl:param name="titlepage.logo.overhang" select="0"/>
