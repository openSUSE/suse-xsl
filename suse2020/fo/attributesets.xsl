...
<xsl:attribute-set name="shade.verbatim.style">
  <xsl:attribute name="background-color">&bw-extra-light-gray;</xsl:attribute>
  <xsl:attribute name="border">&thinline;mm solid &bw-light-gray;</xsl:attribute>
...
<!-- 26. Custom ================================================= -->
<xsl:attribute-set name="title.name.color" use-attribute-sets="dark-green sans.bold.noreplacement"/>

<xsl:attribute-set name="title.number.color">
  <xsl:attribute name="color"><xsl:value-of select="$teal"/></xsl:attribute>
</xsl:attribute-set>
...
<xsl:attribute-set name="corporate-blue">
  <xsl:attribute name="color">
    <xsl:value-of select="$corporate-blue"/>
  </xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="teal">
  <xsl:attribute name="color">
    <xsl:value-of select="$teal"/>
  </xsl:attribute>
</xsl:attribute-set>
...
<xsl:param name="dark-green">
  ...
  <xsl:choose>
    <xsl:when test="$format.print = 1">&bw-darker-gray;</xsl:when>
    <xsl:otherwise>&suse-green;</xsl:otherwise>
  </xsl:choose>
</xsl:param>
...
<xsl:param name="mid-green">
  <!-- See above... -->
  <xsl:choose>
    <xsl:when test="$format.print = 1">&bw-mid-gray;</xsl:when>
    <xsl:otherwise>&suse-green;</xsl:otherwise>
  </xsl:choose>
</xsl:param>

<xsl:param name="corporate-blue">
  <xsl:choose>
    <xsl:when test="$format.print = 1">&bw-darker-gray;</xsl:when>
    <xsl:otherwise>&suse-corporate-blue;</xsl:otherwise>
  </xsl:choose>
</xsl:param>
...
<xsl:param name="teal">
  ...
  <xsl:choose>
    <xsl:when test="$format.print = 1">&bw-mid-gray;</xsl:when>
    <xsl:otherwise>&suse-teal;</xsl:otherwise>
  </xsl:choose>
</xsl:param>
