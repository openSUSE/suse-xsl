...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template
    match="procedure|example|table|task|figure|variablelist|itemizedlist|orderedlist"
  ...
  <xsl:template match="procedure|example|table|task|figure|variablelist|itemizedlist|orderedlist"
