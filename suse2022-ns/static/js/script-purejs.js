...
var bugtrackerUrl = document.querySelector('meta[name="tracker-url"]').getAttribute('content');
var bugtrackerType = document.querySelector('meta[name="tracker-type"]').getAttribute('content');
...
// For Bugzilla
var bscComponent = document.querySelector('meta[name="tracker-bsc-component"]').getAttribute('content') || 'Documentation'; // default component
var bscProduct = document.querySelector('meta[name="tracker-bsc-product"]').getAttribute('content');
var bscAssignee = document.querySelector('meta[name="tracker-bsc-assignee"]').getAttribute('content');
var bscVersion = document.querySelector('meta[name="tracker-bsc-version"]').getAttribute('content');
var bscTemplate = document.querySelector('meta[name="tracker-bsc-template"]').getAttribute('content');

// For GitHub
var ghAssignee = document.querySelector('meta[name="tracker-gh-assignee"]').getAttribute('content');
var ghLabels = document.querySelector('meta[name="tracker-gh-labels"]').getAttribute('content');
var ghMilestone = document.querySelector('meta[name="tracker-gh-milestone"]').getAttribute('content');
var ghTemplate = document.querySelector('meta[name="tracker-gh-template"]').getAttribute('content');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var eHead = document.getElementById('_mainnav');
  var eMain = document.getElementById('_content');
  var eFoot = document.getElementById('_footer');
  var eSideTocAll = document.getElementById('_side-toc-overall');
  var eSideTocPage = document.getElementById('_side-toc-page');
  ...
  addClickListener('_share-fb', function () { share('fb'); });
  addClickListener('_share-in', function () { share('in'); });
  addClickListener('_share-tw', function () { share('tw'); });
  addClickListener('_share-mail', function () { share('mail'); });
  addClickListener('_print-button', function () { print(); });
  ...
  if (eSideTocAll !== null) {
    document.querySelectorAll('#_side-toc-overall li > a.has-children').forEach(function (elm) {
...
function addBugLinks() {
  ...
  document.querySelectorAll('.title-container').forEach(function (container, index) {
    ...
    console.log(
      ...
      titleNumberName !== undefined
        ? titleNumberName.querySelector('.title-number')
        : 'n/a'
    );
