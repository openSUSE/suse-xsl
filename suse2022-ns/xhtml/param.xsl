...
<xsl:param name="glossentry.show.acronym">yes</xsl:param>
  ...
  <xsl:param name="suse.header.import.url">https://static.scc.suse.com/shared-header/1.16/shared-header.esm.js</xsl:param>

  <!-- The assets URL of the SUSE header -->
  <xsl:param name="suse.header.assets.url">https://static.scc.suse.com/shared-header/1.16/assets</xsl:param>
