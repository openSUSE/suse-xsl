...
<xsl:param name="glossentry.show.acronym">yes</xsl:param>
  ...
  <xsl:param name="suse.header.import.url">https://d12w0ryu9hjsx8.cloudfront.net/shared-header/1.7/shared-header.esm.js</xsl:param>

  <!-- The assets URL of the SUSE header -->
  <xsl:param name="suse.header.assets.url">https://d12w0ryu9hjsx8.cloudfront.net/shared-header/1.7/assets</xsl:param>
